                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="form-biodata" class="form" method="POST">  
                                        <input type="hidden" id="nik_2" name="nik_2" required>                                      
                                        <div class="divider">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" id="tinggi" name="tinggi" class="form-control" min="30" max="300" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" id="berat_badan" name="berat_badan" class="form-control" min="30" max="300" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="saudara_tiri" name="saudara_tiri" value="0" min="0" max="50" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="saudara_angkat" name="saudara_angkat" value="0" min="0" max="50" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="nik_ayah" name="nik_ayah" minlength="16" maxlength="16" class="form-control" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" id="domisili_ayah">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    <label>Alamat Lengkap Tempat Tinggal (AYAH)</label>
                                                    <input type="text" id="alamat_ayah" name="alamat_ayah" class="form-control" readonly required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="nik_ibu" name="nik_ibu"  minlength="16" maxlength="16" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select sel_dom_ibu" id="sel_dom_ibu"required>
                                                        <option value="">Silahkan Pilih</option>
                                                        <option value="sama">Sama Dengan Pendaftar</option>    
                                                        <option value="beda">Beda Alamat</option>    
                                                    </select>
                                        ...
                                        <div class="row" id="domisili_ibu">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    <label>Alamat Lengkap Tempat Tinggal (IBU)</label>
                                                    <input type="text" id="alamat_ibu" name="alamat_ibu" class="form-control"  readonly required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">    
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select sel_dom_wali" id="sel_dom_wali" required>
                                                        <option value="">Silahkan Pilih</option>
                                                        <option value="sama">Sama Dengan Pendaftar</option>    
                                                        <option value="beda">Beda Alamat</option>    
                                                    </select>
                                        ...
                                        <div class="row" id="domisili_wali">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    <label>Alamat Lengkap Tempat Tinggal (WALI)</label>
                                                    <input type="text" id="alamat_wali" name="alamat_wali" class="form-control" readonly required>
                                                </div>
                                            </div>
                                        </div>
