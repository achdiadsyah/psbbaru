                                ...
                                <div class="card-body">
                                    <?php if(check_close(psb_detail("pengumuman_adm_undangan"), psb_detail("tutup_daftar_ulang_reguler")) == "Open"): ?>
                                        <?php if ($user->s_lulus_adm == "1"): ?>
                                            <div id="lulus">
                                                <center>
                                                    <p class="lead">Selamat!! Anda di nyatakan <br><span class="badge bg-success">LULUS SELEKSI BERKAS</span></p>
                                                    <br/>
                                        ...
                                        <?php elseif ($user->s_lulus_adm == "0"): ?>
                                            <div id="nolulus">
                                                <center>
                                                    <p class="lead">Maaf :( Anda <br><span class="badge bg-danger">Tidak Lulus ADM</span></p>
                                                    <br/>
